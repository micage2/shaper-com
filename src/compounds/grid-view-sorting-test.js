...
import GridViewSorting from '../dom-comps/grid-view-sorting.js';
...
function GridViewSortingTest(model) {
    if (!model) {
    ...
    function showTable(tableUuid) {
        ...
        const gridView = DOM.create(GridViewSorting, {
            model: model,
            tableUuid: tableUuid
        });
...
export default GridViewSortingTest;
